        ...
        <div
            ...
            <div class="aspect-video bg-slate-900 relative overflow-hidden">
                ...
                <div class="absolute bottom-4 left-4 z-10">
                    ...
                    @endphp
                    <span
                        class="px-3 py-1 {{ $statusClass }} border rounded-full text-xs font-bold uppercase tracking-wider backdrop-blur-md">
                        {{ $project->status }}
                    </span>
                </div>
            </div>
            ...
            <div class="p-4 md:p-6 relative">
                <h3 class="text-xl md:text-2xl font-bold mb-2 group-hover:text-primary transition-colors">
                    {{ $project->title }}</h3>
                <p class="text-text-secondary text-sm mb-4 line-clamp-2 leading-relaxed">{{ $project->short_description }}
                </p>
